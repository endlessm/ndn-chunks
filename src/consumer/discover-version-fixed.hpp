...
#ifndef NDN_CHUNKS_CONSUMER_DISCOVER_VERSION_FIXED_HPP
#define NDN_CHUNKS_CONSUMER_DISCOVER_VERSION_FIXED_HPP
...
#endif // NDN_CHUNKS_CONSUMER_DISCOVER_VERSION_FIXED_HPP
