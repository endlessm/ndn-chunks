...
#ifndef NDN_CHUNKS_CONSUMER_AIMD_STATISTICS_COLLECTOR_HPP
#define NDN_CHUNKS_CONSUMER_AIMD_STATISTICS_COLLECTOR_HPP
...
#endif // NDN_CHUNKS_CONSUMER_AIMD_STATISTICS_COLLECTOR_HPP
